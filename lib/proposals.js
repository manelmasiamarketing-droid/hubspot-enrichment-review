...
const { matchClientsToCompanies, partnerTierFromDevices, SPAIN_PORTUGAL, COUNTRY_TO_LANGUAGE } = require('./matching');
...
async function buildProposals(onProgress) {
  ...
  for (const clientName of clientNames) {
    ...
    const effectiveCountry = p.current.country || hist.country;

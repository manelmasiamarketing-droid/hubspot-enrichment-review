...
const { matchClientsToCompanies, partnerTierFromDevices, SPAIN_PORTUGAL, COUNTRY_TO_LANGUAGE, countryToSlug } = require('./matching');
...
async function buildProposals(onProgress) {
  ...
  function trackCountry(p, hist) {
    ...
    if (!agg) {
      agg = { bestCountry: null, bestDevices: -1, allCountries: new Set() };

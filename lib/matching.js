...
// numero_de_dispositivos bucket options confirmed via get_properties: 0-49,
// 50-99, 100-199, 200-299, 300-399, 400-499, +500.
function deviceCountBucket(n) {
  if (n >= 500) return '+500';
  if (n >= 400) return '400-499';
  if (n >= 300) return '300-399';
  if (n >= 200) return '200-299';
  if (n >= 100) return '100-199';
...
module.exports = {
  ...
  SPAIN_PORTUGAL, COUNTRY_TO_LANGUAGE, countryToSlug, deviceCountBucket,
};
